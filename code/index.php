...
<body>
    <div class="main-bg">
        ...
        <div class="main-content-container">
            <div class="main-text">
                <h1 class="main-h1">Platforme de Gestion des Offres d'Emploi et de Stage.</h1>
                <p class="main-p">Bienvenue dans la platforme pour le recrutement des lauréants et des stagiaires de l'ENCG de Tanger.
                Pour donner une suite rapide de et fluide de votre annance merci de cliquer sur l'icône ci-dessous.</p>
                <button>START</button>
            </div>
            <div class="main-image">
                <img src="css/assets/Intersection 1.svg" alt="main-image">
            </div>            
        </div>
    </div>
    <div class="np-section">
        <div class="np-div-center">
            <div class="title-div">
                <div class="title">
