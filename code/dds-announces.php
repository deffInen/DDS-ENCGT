    ...
    <div class="main-bg-container">
        <nav>
            <div>
                ...
                <ul>
                    ...
                    <li><a href="/DDS/DDS-ENCGT/code/dds-announces.php" class="menu-option" id="active">ANNONCES</a></li>
                </ul>
            </div>
        </nav>
        <div class="main-content-container">
            <div class="info-content-container">
                ...
                $sql = "SELECT id, announce, created_at FROM announces";
